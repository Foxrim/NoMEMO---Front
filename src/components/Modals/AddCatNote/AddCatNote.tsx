...
export default function AddCatNote({
  handleModalAdd,
  handleAddNote,
  handleAddCategory,
}: AddCatNoteProps) {
  ...
  return (
    <div className={styles.addCatNote}>
      <div className={styles.addCatNoteModal}>
        ...
        <h2>Ajouts</h2>
        <Buttons className={styles.addNewNote} onClick={switchModalNotes}>
          Nouvelle note
        </Buttons>
        <Buttons
          className={styles.addNewCategorie}
          onClick={switchModalCategories}
        >
          Nouvelle catégorie
        </Buttons>
      </div>
